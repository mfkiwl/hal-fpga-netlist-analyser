        ...
        TEST_START
            {
                ...
                std::shared_ptr<Net> backslash_net = nl->create_net(test_utils::MIN_NET_ID + 4, "\\net\\_4");
        ...
        TEST_START
            {
                ...
                std::shared_ptr<Gate> test_gate = nl->create_gate(MIN_GATE_ID + 2,
                ...
                std::shared_ptr<Gate> test_gate_ref =
